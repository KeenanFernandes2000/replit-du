  ...
  return (
    <section className="py-24 bg-gradient-to-r from-primary to-primary/90">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-white/90 text-lg mb-10 max-w-2xl mx-auto">Contact us today to discuss how our digital solutions can help you achieve your business goals and stay ahead in the digital era in Jordan.</p>
        <Button 
