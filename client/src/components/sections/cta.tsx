  ...
  return (
    <section className="py-20 bg-primary">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">Contact us today to discuss how our digital solutions can help you achieve your business goals and stay ahead in the digital era in Jordan.</p>
        <Button 
