    ...
    <section id="partnership" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">du has partnered with potential.com, bringing world-class AI Agentic solutions to the UAE market.</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center lg:space-x-12">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-600 mb-6">Through our strategic partnership with potential.com, we deliver world-class AI Agentic solutions that are customized for the Pakistani market while maintaining global standards of excellence.</p>
